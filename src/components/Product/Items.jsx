...
export default function Items({ product }) {
  return (
    <NavLink
      ...
      className='flex-grow min-w-[200px] bg-white grid items-center justify-center lg:w-1/5 sm:1/4 shadow hover:shadow-xl hover:scale-95 duration-500 text-center text-gray-800 border border-gray-300 rounded-2xl px-4 py-2'>
